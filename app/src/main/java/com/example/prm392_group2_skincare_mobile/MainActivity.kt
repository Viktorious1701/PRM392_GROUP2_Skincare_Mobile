// app/src/main/java/com/example/prm392_group2_skincare_mobile/MainActivity.kt
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // setupActionBarWithNavController(navController, appBarConfiguration) // Use this if you have a top AppBar
